...
class DataLoader:
    """
    A JAX-friendly dataloader for loading environments and their trajectories.
    """

    def __init__(self, dataset, t_eval=None, batch_size=-1, int_cutoff=1.0, shuffle=True, adaptation=False, key=None):
