...
nb_outer_steps_max = 1000           ## maximum number of outer steps when using NCF-T2
...
inner_tol_node = 1e-7               ## Tolerance for the inner optimisation on the weights
inner_tol_ctx = 1e-6                ## Tolerance for the inner optimisation on the contexts
