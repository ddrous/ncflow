...
flow_pool_count = 4               ## Number of neighboring contexts j to use for a flow in env e
context_size = 1024
nb_epochs = 24000*5
...
sched_node = optax.piecewise_constant_schedule(init_value=1e-4,
                        boundaries_and_scales={nb_total_epochs//3:0.1, 2*nb_total_epochs//3:0.01})

sched_ctx = optax.piecewise_constant_schedule(init_value=1e-4,
                        boundaries_and_scales={nb_total_epochs//3:0.1, 2*nb_total_epochs//3:0.01})
...
sched_ctx_new = optax.piecewise_constant_schedule(init_value=1e-4,
                        boundaries_and_scales={nb_total_epochs//3:0.1, 2*nb_total_epochs//3:0.01})
# sched_ctx_new = 1e-5
