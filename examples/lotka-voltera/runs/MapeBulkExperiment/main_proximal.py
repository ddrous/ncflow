...
# ## Plot a histogram of the MAPES
# import matplotlib.pyplot as plt
# plt.hist(odd_crit_all_mape, bins=50)

## Print the Min and Max of the MAPEs
print("Min and Max of the MAPES are:", np.min(odd_crit_all_mape), np.max(odd_crit_all_mape))

visualtester.visualize(adapt_dataloader, int_cutoff=1.0, save_path=adapt_folder+"huge_adapt_loss.png");
