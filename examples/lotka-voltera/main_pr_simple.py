...
run_folder = "./runs/SmallContextExperiment/"
...
c = plt.contourf(X, Y, losses, levels=150, cmap='turbo')
# plt.colorbar(c)
...
plt.xlabel("dim 0", fontsize=22)
plt.ylabel("dim 1", fontsize=22)
...
plt.savefig(run_folder+"context_loss.png", dpi=300, bbox_inches='tight')
