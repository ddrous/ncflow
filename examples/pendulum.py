...
train_dataloader = DataLoader("data/simple_pendulum_big.npz", batch_size=32, int_cutoff=0.2, shuffle=True)
...
trainer.train(nb_epochs=200, update_context_every=1, key=jax.random.PRNGKey(0))

#%%

## Test and visualise the results on a test dataloader

test_dataloader = DataLoader("data/simple_pendulum_small.npz", batch_size=1, int_cutoff=0.2, shuffle=False)
visualtester = VisualTester(test_dataloader, trainer)
visualtester.visualise(e=0, traj=0, cutoff=False, save_path="data/")
